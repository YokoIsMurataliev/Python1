...
background = pygame.image.load("lib\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lib\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lib\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image_container = ['lib\Coin1.png', 'lib\Coin2.png', 'lib\Coin3.png']
...
#___________________
pygame.mixer.music.load("lib\\background.wav")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('lib\crash.wav').play()
        time.sleep(1)
